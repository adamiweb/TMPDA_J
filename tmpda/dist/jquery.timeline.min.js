...
Plugin.prototype.createImage=function(t)
{
var i=null;
if(t.image)
  {
    ...
    s.forEach(function(val){
        if(val!=="")
          i?i=i.after(o("<img />").attr("src",val).addClass("timeline-item-image timeline-item")):i=o("<img />").attr("src",val).addClass("timeline-item-image timeline-item").after(i);
      alert(i+".....8");
    });
  }
