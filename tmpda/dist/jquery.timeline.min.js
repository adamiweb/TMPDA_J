...
if(t.image)
  ...
  if(!t.link)return i;if(i)return o("<a />").attr({href:t.link.trim(),target:"_blank"}).append(i)};
                            ...
                            Plugin.prototype.createItem=function(t,y,index){var i=o("<div />").addClass("timeline-item-container");var e=o("<div />").addClass("timeline-item-body");var g=o('<div />').attr('id', 'lightbox'+y+(index+1));var n=this.createImage(t,g);var a=this.createDescription(t);this.createTitle(t).appendTo(i);if(n){g.appendTo(e);/*n.appendTo(g);*/o("<div />").addClass("clear").appendTo(g);}if(a)a.appendTo(e);e.appendTo(i);return i};
