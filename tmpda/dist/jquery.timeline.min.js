...
Plugin.prototype.createImage=function(t,g)
{
var i=null;
if(t.image)
  {
    ...
    s.forEach(function(val,index){
        if(val!=="")
        {
          index==0?i=o("<a />").attr("href",val).append(o("<img />").attr({"src":val.substr(0,val.lastIndexOf("."))+"_s.jpg","alt":"Event Photos","title":g.attr("id").substr(g.attr("id").length-4,4)}).addClass("timeline-item-image timeline-item")):i=o("<a />").attr("href",val);
          g.append(i);
          alert(val.substr(0,val.lastIndexOf("."))+"_s.jpg"+".....16");
        }
    });
  }
  if(!t.link)return i;if(i)return o("<a />").attr({href:t.link.trim(),target:"_blank"}).append(i)};
                            ...
                            Plugin.prototype.createDescription=function(t){var i=t.description?o("<p />").addClass("timeline-item-description timeline-item"):null;var e=this.prepareContent(t.description);if(i&&t.link)o("<a />").attr({href:t.link.trim(),target:"_blank"}).append(e).appendTo(i);else if(i)i.append(e);return i};Plugin.prototype.prepareContent=function(t){if(this.options.allowRawContent)return o("<span />").html(t);return o("<span />").text(t)};Plugin.prototype.createItem=function(t,y){var i=o("<div />").addClass("timeline-item-container");var e=o("<div />").addClass("timeline-item-body");var g=o('<div />').attr('id', 'lightbox'+y);var n=this.createImage(t,g);var a=this.createDescription(t);this.createTitle(t).appendTo(i);if(n){g.appendTo(e);/*n.appendTo(g);*/o("<div />").addClass("clear").appendTo(g);}if(a)a.appendTo(e);e.appendTo(i);return i};Plugin.prototype.dispatch=function(t,i){this.options.container.trigger(t,i)};o.fn.timeline=function(t){return this.each(function(){if(!o.data(this,"plugin")){o.data(this,"plugin",new Plugin(this,t))}})};o.fn.timeline.defaults={container:"[data-timeline]",apiUrl:null,allowRawContent:false,transformer:function(t){return t}};o(document).ready(function(){o(o.fn.timeline.defaults.container).on("timeline.after.generate",function(){o(this).addClass("timeline")}).timeline()})})(jQuery,undefined);
