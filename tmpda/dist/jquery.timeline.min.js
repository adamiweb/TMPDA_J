...
Plugin.prototype.createImage=function(t){var i; if(t.image){
let s, attr;
  s=t.image.trim().concat(",").split(",");alert(s[0]+"....0....."+s[1]+"....1");
  attr = s.forEach(function(val){
  i+=o("<img />").attr("src",attr[val].trim()).addClass("timeline-item-image timeline-item");});
  alert(i);
}else
i=null;
